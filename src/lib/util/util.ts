...
import { NetworkTableTypeInfos } from 'src/lib/types/types';

import type { BinaryMessage, NetworkTableTypeInfo, NetworkTableTypes, TypeNum, TypeString } from 'src/lib/types/types';
...
export class Util {
     ...
     */
    static getNetworkTableTypeFromObject(data: NetworkTableTypes): NetworkTableTypeInfo {
    ...
    static createServerUrl(fqdn: string, port: number): string {
